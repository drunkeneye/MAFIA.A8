...
# for z in *.png; do magick $z -interpolate Nearest -filter point  -resize 80x152! -colorspace Gray -normalize -colors 5 -normalize -colors 5  -remap clut.png  PNG8:"../${z%.jpeg}.png"; done
#for z in *.png; do magick $z   -resize 80x152! -colorspace Gray -normalize  -dither FloydSteinberg -normalize -colors 5 -normalize -colors 5  -remap clut.png  PNG8:../$z; done
