...
rastaconv_command = './rastaconv input.png /h=200 /pal=laoo /filter=box /s=8192 /save=1000000 /max_evals=20000000'
...
def process_png_files():
    ...
    for png_file in pics_dir.glob("*.png"):
        ...
        output_subdir = outputs_dir / png_file.stem
        ...
        # Copy output.png* files from the current directory to outputs/<name of the png file>/
        for output_file in Path("./RastaConverter").glob("output.png*"):
            shutil.copy(output_file, output_subdir)
...
if __name__ == "__main__":
    ...
    shutil.copy("../assets/final.xex", "../assets/finalmap.gfx")
